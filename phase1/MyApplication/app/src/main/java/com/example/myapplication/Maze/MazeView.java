    ...
    private void checkExit() {
        if (player == exit && games_played < num_games) {
            ...
            if (games_played >= num_games) {
                ...
                UserManager.update_statistics(contexts, user_in_maze, user_in_maze.getScore(),
                        user_in_maze.getStreaks(), user_in_maze.getNum_maze_games_played(),
                        user_in_maze.getLast_played_level(), user_in_maze.getLoad_moles_stats());
